...
public class RzgZeile {
    ...
    // BSM MR IN <  Rückversicherungsparameter

    /** Zeitabhängige Rückversicherungsparameter */
    final MrParameterZeitabhaengig mrParamZeitAbh;

    /** Zeitunabhängige Rückversicherungsparameter */
    ...
    // BSM MR IN < zusätzliche Spalten im Excelblatt rzg 
    ...
    /** Zedierter rechnungsmäßiger Zins (Auf Grundlage des Rechnungszinses) */
    ...
    // RV-Gebühr als Hilfsgröße an dieser Stelle zur Summierung auf agg-Ebene (nur Java)
    ...
    public void zeitRekursionL01(final AggZeile agg) {
        ...
        if (zeit > 0) {
            ...
            // BSM MR IN <
            /*
             *  Momentan keine Rückversicherung bei fondsgebundenem Geschäft, deswegen werden die Rückversicherungsgrößen bei FLV hart
             *  auf null gesetzt  
             */
    ...
    /**
     *  Übertrag festgelegte RfB (Im BSM als Teil der HGB DRSt repräsentiert) in freie RfB . Spalte: TODO: update
     * 
     * @return der Wert
     */
