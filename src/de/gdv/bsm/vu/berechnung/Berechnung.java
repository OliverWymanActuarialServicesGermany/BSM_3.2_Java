...
public class Berechnung {
	...
	public void berechnung(final int pfad, final Optional<File> transferDir)
		...
		if (ausgabe) {
			...
			final Map<Integer, Map<Integer, List<Pair<String, Pair<String, Pair<String, Integer>>>>>> fields = save2csv.getFields();
							...
							for (int i = 0; i < rzgZeilen.size(); ++i) {
								...
								for (Pair<String, Pair<String, Pair<String, Integer>>> p : list) {
									...
									if (f.a.equals("agg")) {
										...
										if(firstRzg) {
											outRzg.print(rzgZeilen.get(i).getLoB()+";"+rzgZeilen.get(i).getZeit()+";"+rzgZeilen.get(i).getZinsGeneration()+";"+rzgZeilen.get(i).getAltNeuBestand());
